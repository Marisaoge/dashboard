        ...
        <div className="flex space-x-4 mt-6 overflow-x-auto">
          <button
            className={`px-4 py-2 rounded-lg flex items-center whitespace-nowrap ${
              activeTab === 'overview' ? 'bg-blue-600 text-white' : 'bg-white text-gray-600'
            }`}
          ...
          <button
            className={`px-4 py-2 rounded-lg flex items-center whitespace-nowrap ${
              activeTab === 'patients' ? 'bg-blue-600 text-white' : 'bg-white text-gray-600'
            }`}
          ...
          <button
            className={`px-4 py-2 rounded-lg flex items-center whitespace-nowrap ${
              activeTab === 'vitals' ? 'bg-blue-600 text-white' : 'bg-white text-gray-600'
            }`}
          ...
          <button
            className={`px-4 py-2 rounded-lg flex items-center whitespace-nowrap ${
              activeTab === 'appointments' ? 'bg-blue-600 text-white' : 'bg-white text-gray-600'
            }`}
          ...
          <button
            className={`px-4 py-2 rounded-lg flex items-center whitespace-nowrap ${
              activeTab === 'operations' ? 'bg-blue-600 text-white' : 'bg-white text-gray-600'
            }`}
